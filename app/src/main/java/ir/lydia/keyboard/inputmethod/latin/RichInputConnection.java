...
import ir.lydia.keyboard.inputmethod.compat.InputConnectionCompatUtils;
import ir.lydia.keyboard.inputmethod.latin.common.Constants;
import ir.lydia.keyboard.inputmethod.latin.common.StringUtils;
import ir.lydia.keyboard.inputmethod.latin.common.UnicodeSurrogate;
import ir.lydia.keyboard.inputmethod.latin.inputlogic.PrivateCommandPerformer;
...
import ir.lydia.keyboard.inputmethod.latin.utils.DebugLogUtils;
import ir.lydia.keyboard.inputmethod.latin.utils.NgramContextUtils;
import ir.lydia.keyboard.inputmethod.latin.utils.ScriptUtils;
import ir.lydia.keyboard.inputmethod.latin.utils.SpannableStringUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See ir.lydia.keyboard.inputmethod.latin.common.Constants.UnicodeSurrogate
