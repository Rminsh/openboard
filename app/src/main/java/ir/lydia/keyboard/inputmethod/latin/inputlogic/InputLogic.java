...
package ir.lydia.keyboard.inputmethod.latin.inputlogic;
...
import ir.lydia.keyboard.inputmethod.compat.SuggestionSpanUtils;
...
import ir.lydia.keyboard.inputmethod.latin.Dictionary;
import ir.lydia.keyboard.inputmethod.latin.DictionaryFacilitator;
import ir.lydia.keyboard.inputmethod.latin.LastComposedWord;
import ir.lydia.keyboard.inputmethod.latin.LatinIME;
import ir.lydia.keyboard.inputmethod.latin.NgramContext;
import ir.lydia.keyboard.inputmethod.latin.RichInputConnection;
import ir.lydia.keyboard.inputmethod.latin.Suggest;
import ir.lydia.keyboard.inputmethod.latin.Suggest.OnGetSuggestedWordsCallback;
import ir.lydia.keyboard.inputmethod.latin.SuggestedWords;
import ir.lydia.keyboard.inputmethod.latin.SuggestedWords.SuggestedWordInfo;
import ir.lydia.keyboard.inputmethod.latin.WordComposer;
...
import ir.lydia.keyboard.inputmethod.latin.common.StringUtils;
...
import ir.lydia.keyboard.inputmethod.latin.settings.SettingsValuesForSuggestion;
import ir.lydia.keyboard.inputmethod.latin.settings.SpacingAndPunctuations;
import ir.lydia.keyboard.inputmethod.latin.suggestions.SuggestionStripViewAccessor;
import ir.lydia.keyboard.inputmethod.latin.utils.AsyncResultHolder;
import ir.lydia.keyboard.inputmethod.latin.utils.InputTypeUtils;
import ir.lydia.keyboard.inputmethod.latin.utils.RecapitalizeStatus;
import ir.lydia.keyboard.inputmethod.latin.utils.StatsUtils;
import ir.lydia.keyboard.inputmethod.latin.utils.TextRange;
...
public final class InputLogic {
     ...
     *     {@link ir.lydia.keyboard.inputmethod.keyboard.KeyboardSwitcher#getKeyboardShiftMode()}
     * @return the complete transaction object
     */
    ...
    /**
     * Make a {@link ir.lydia.keyboard.inputmethod.latin.SuggestedWords} object containing a typed word
     * and obsolete suggestions.
     * See {@link ir.lydia.keyboard.inputmethod.latin.SuggestedWords#getTypedWordAndPreviousSuggestions(
     *      SuggestedWordInfo, ir.lydia.keyboard.inputmethod.latin.SuggestedWords)}.
